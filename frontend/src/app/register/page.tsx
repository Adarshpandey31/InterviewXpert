...
export default function RegisterPage() {
  ...
  useEffect(() => {
    if (searchParams.get("plan")) {
      form.setValue("plan", searchParams.get("plan") as "free" | "basic" | "professional" | "enterprise")
      setCurrentStep("details")
    }
    if (searchParams.get("role")) {
      form.setValue("role", searchParams.get("role") as "student" | "interviewer")
    }
  }, [searchParams, form])
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    router.push(values.role === "student" ? "/dashboard/student" : "/dashboard/interviewer")
  }
